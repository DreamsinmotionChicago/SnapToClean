            ...
            <div className="grid grid-cols-2 gap-6 items-start">
              ...
              <div className="rounded-[28px] bg-white/95 p-6 border-2 border-[#04384a] h-[400px] flex flex-col justify-between w-full relative overflow-hidden">
                ...
                <div className="space-y-4 relative z-10">
                  <div className="text-xl font-bold uppercase tracking-wide text-white">Talk to a junk specialist</div>
                  <div className="text-4xl font-bold text-white">{BRAND.phone}</div>
                  <p className="text-lg font-semibold text-white">Fast estimates • Same-day service • Licensed & insured</p>
                </div>
          ...
          <div className="lg:hidden">
            <div className="grid gap-6 text-center">
              ...
              <div className="self-start rounded-[28px] bg-white/95 p-6 border-2 border-[#04384a] relative overflow-hidden">
                ...
                <div className="text-sm font-bold uppercase tracking-wide text-white relative z-10">Talk to a junk specialist</div>
                <div className="mt-2 text-2xl font-bold text-white relative z-10">{BRAND.phone}</div>
                <p className="mt-2 text-sm font-semibold text-white relative z-10">Fast estimates • Same-day service • Licensed & insured</p>
